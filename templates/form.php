...
<form class="form form--add-lot container form--invalid" action="add.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form__container-two">
        <div class="form__item form__item--invalid">
            ...
            <input id="lot-name" type="text" name="caption" placeholder="Введите наименование лота">
        ...
        <div class="form__item">
            ...
            <select id="category" name="category_id">
                ...
                <?php foreach ($goods as $good) : ?>
                    <option value="<?=$good['id'] ?>"><?= esc($good['title']); ?></option>
                <?php endforeach; ?>
            </select>
    ...
    <div class="form__item form__item--wide">
        ...
        <textarea id="message" name="discription" placeholder="Напишите описание лота"></textarea>
    ...
    <div class="form__container-three">
        ...
        <div class="form__item">
            ...
            <input class="form__input-date" id="lot-date" type="text" name="completion_date" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
