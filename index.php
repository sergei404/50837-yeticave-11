...
for ($i=0; $i < count($adverts); $i++) {
    $list .= '<li class="lots__item lot">
                <div class="lot__image">
                    <img src="'.$adverts[$i]['url'].'" width="350" height="260" alt="">
                </div>
                 <div class="lot__info">
                    <span class="lot__category">'.$adverts[$i]['category'].'</span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html">'.$adverts[$i]['name'].'</a></h3>
        ...
        <header class="main-header">
            <div class="main-header__container container">
                ...
                <nav class="user-menu">
                    ...
                    <?php
                    echo getUserAuth($is_auth, $user_name);
                    ?>
                ...
                <?php 
                    for ($i=0; $i < count($goods); $i++) {
                        echo '<li class="promo__item promo__item--boards">
                                <a class="promo__link" href="pages/all-lots.html">' . $goods[$i] . '</a>
                            </li>';
                    } 
                ?> 
                </ul>
